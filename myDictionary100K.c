...
#define SIZE_NEW_WORD 15
#define SIZE_MEANING 2500
#define SIZE_DATA_SOUNDEX 15000
#define SIZE_CHAR 3
...
// gcc myDictionary100K.c -LBTreeLib/lib -lbt -IBTreeLib/inc
...
int main(){
    char db_dictionary[] = "100K_Words.db";
    char db_soundex[] = "100K_Words_Soundex.db";
    char file_name[] = "Text100K.txt";
